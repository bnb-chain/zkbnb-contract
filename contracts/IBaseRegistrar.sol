...
interface IBaseRegistrar {
    ...
    event NameRegistered(string name, bytes32 node, address owner, bytes32 L2Owner);
    ...
    function setThisL2Owner(bytes32 L2Owner) external;

    // Register a node under the base node.
    function register(string calldata name, address owner, bytes32 L2Owner) external;
}
